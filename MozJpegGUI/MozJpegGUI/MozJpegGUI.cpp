...
// MozJpegGUI.cpp : アプリケーションのクラス動作を定義します。
//
...
BEGIN_MESSAGE_MAP(CMozJpegGUIApp, CWinApp)
...
CMozJpegGUIApp::CMozJpegGUIApp()
{
}


// 唯一の CMozJpegGUIApp オブジェクト

CMozJpegGUIApp theApp;


// CMozJpegGUIApp の初期化

BOOL CMozJpegGUIApp::InitInstance()
{
